...
import  LmsDashboard from "./dashboard-courses";
import CreatePriceCourse from "./create/components/create-price-course";
import StudentManagement from "../students/admin-students";
const invoices = [
